...
export class SharedService{
    ...
    public getMenuListByRoleName(jsonData : any){
        ...
        return this.http.post(this.phpServicePoint+'getMenuByEmpRole.php',bodyString)
               .map((response:Response) => response.json())
               .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public getMenuTrasactions(jsonData : any){
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'getMenuTrasactions.php',bodyString)
        .map((response:Response) => response.json())
        .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public getMenuTrasactionsDet(jsonData : any){
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'getMenuTrasactionsDet.php',bodyString)
        .map((response:Response) => response.json())
        .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public changeTransactionStatus(jsonData : any){
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'changeTransactionStatus.php',bodyString)
        .map((response:Response) => response.json())
        .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public getCategorySubcategoryByRole(jsonData:  any) {
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'getCategorySubcategoryByRole.php',bodyString)
               .map((response:Response) => response.json())
               .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public sendOTP(jsonData: any) {
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'sendOTPtoMobile.php',bodyString)
               .map((response:Response) => response.json())
               .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public changePassword(jsonData: any) {
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'changePassword.php',bodyString)
               .map((response:Response) => response.json())
               .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public updateDataByUpdateType(jsonData: any, updateType : any) {
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'updateInTable.php?updateType='+updateType,bodyString)
               .map((response:Response) => response.json())
               .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
    ...
    public insertDataByInsertType(jsonData: any, insertType : string) {
        let bodyString = JSON.stringify(jsonData);
        return this.http.post(this.phpServicePoint+'insertInTable.php?insertType='+insertType,bodyString)
               .map((response:Response) => response.json())
               .catch((error:any) => Observable.throw(error.json().error || 'Server error'));
    }
